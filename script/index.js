        ...
        `<div id = "dish-card">
            <div id="left">
                ...
                <div id="favourite-button"> 
                    <button type="click" id="favourite-button-click" onclick="addToFav(this.value)" value = "${number}-${dish}-${area}-${category}-${pic}" class="button">Add To Favourite </button>
                </div>
            </div>
            <div id="right">
                <div id = "dish-name">
                ...
                <div id="dish-abt">
                    <span> click on View Recipe to know the recipe of ${element.strMeal}.</span>
                </div>
                <div>
                    <a href = "recipe.html"> <button  id="view-recipe" class="button" onclick="javascript:testing(this.value)" value= "${number}" > View Receipe</button></a>
                </div>
            </div>
        </div>`
        
        display_meal.innerHTML += html
...
$('#search-button').click(fetchDishDetails)